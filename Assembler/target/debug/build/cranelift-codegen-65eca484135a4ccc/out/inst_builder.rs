...
pub trait InstBuilder<'f>: InstBuilderBase<'f> {
    ...
    #[allow(non_snake_case)]
    fn vconst<T1poolConstant: Into<ir::Constant>>(self, TxN: crate::ir::Type, N: T1poolConstant) -> Value {
        let N = N.into();
    ...
    #[allow(non_snake_case)]
    fn shuffle<T1uimm128: Into<ir::Immediate>>(self, a: ir::Value, b: ir::Value, mask: T1uimm128) -> Value {
        let mask = mask.into();
    ...
    /// must indicate a valid lane index for the type of ``x``.
    #[allow(non_snake_case)]
    fn x86_pextr<T1uimm8: Into<ir::immediates::Uimm8>>(self, x: ir::Value, Idx: T1uimm8) -> Value {
        let Idx = Idx.into();
        let ctrl_typevar = self.data_flow_graph().value_type(x);
    ...
    /// must indicate a valid lane index for the type of ``x``.
    #[allow(non_snake_case)]
    fn x86_pinsr<T1uimm8: Into<ir::immediates::Uimm8>>(self, x: ir::Value, Idx: T1uimm8, y: ir::Value) -> Value {
        let Idx = Idx.into();
        let ctrl_typevar = self.data_flow_graph().value_type(x);
    ...
    #[allow(non_snake_case)]
    fn x86_insertps<T1uimm8: Into<ir::immediates::Uimm8>>(self, x: ir::Value, Idx: T1uimm8, y: ir::Value) -> Value {
        let Idx = Idx.into();
        let ctrl_typevar = self.data_flow_graph().value_type(x);
