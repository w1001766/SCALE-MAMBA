...
impl fmt::Display for LibcallCallConv {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        f.write_str(match *self {
            ...
            LibcallCallConv::BaldrdashSystemV => "baldrdash_system_v",
            LibcallCallConv::BaldrdashWindows => "baldrdash_windows",
...
impl str::FromStr for LibcallCallConv {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            "isa_default" => Ok(LibcallCallConv::IsaDefault),
            "fast" => Ok(LibcallCallConv::Fast),
            "cold" => Ok(LibcallCallConv::Cold),
            "system_v" => Ok(LibcallCallConv::SystemV),
            "windows_fastcall" => Ok(LibcallCallConv::WindowsFastcall),
            "baldrdash_system_v" => Ok(LibcallCallConv::BaldrdashSystemV),
            "baldrdash_windows" => Ok(LibcallCallConv::BaldrdashWindows),
            "probestack" => Ok(LibcallCallConv::Probestack),
            _ => Err(()),
        }
    }
}
